...
- [**AI Collaboration Guide**](/GEMINI.md): Foundational context and guidelines for AI models to ensure consistency and maintain code quality.
- [**Agent Instructions**](/docs/AGENT_INSTRUCTIONS.md): Central instructions for AI agents working in this repo.
- [**Project Overview**](/docs/overview.md): A high-level summary of the project's purpose and goals.
